...
-이와 같은 내부클래스를 staitc으로 선언하면 Nested클래스라고한다.
-정적 멤버변수, 정적 멤버메소드를 가질수 있다. 
...
class OuterClass {
	...
	static void outerStaticMethod() {
		...
		접근할수있다. (Method영역에서는 Heap영역을 참조할수없다.)
		 */	 
...
public class E02InnerStaticClass {
	...
	public static void main(String[] args) {
		...
		/*
		내부정적 클래스이 인스턴스형 멤버에 접근할때는 객체를 생성한 후
		참조변수를 통해 접근해야한다.
		 */
